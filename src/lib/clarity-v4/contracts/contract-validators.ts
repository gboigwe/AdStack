...
// Validator helper 86
export function isPositiveAmount86(amount: bigint): boolean {
  return amount > BigInt(0);
}

// Validator helper 87
export function isPositiveAmount87(amount: bigint): boolean {
  return amount > BigInt(0);
}

// Validator helper 88
export function isPositiveAmount88(amount: bigint): boolean {
  return amount > BigInt(0);
}

// Validator helper 89
export function isPositiveAmount89(amount: bigint): boolean {
  return amount > BigInt(0);
}

// Validator helper 90
export function isPositiveAmount90(amount: bigint): boolean {
  return amount > BigInt(0);
}
